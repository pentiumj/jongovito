...
<?php require_once "./plantilla/metas.php"; ?>
    ...
    <body>
        ...
        <div id="contenedorInf"> 
            ...
            <div class="ubi">Entregas >> Realizadas</div>
                <div class="titulo1">Productos entregados</div></br></br>
                
                <?php $totales = consultarOferentes(true); ?>
                <?php 
                $productos = 0;
                ...
                <script>
                   ...
                   jQuery(function($){
                            $('.table').footable({
                                    "columns": $.getJSON('columnasEntregas.php'),
                                    "rows": $.getJSON('filasEntregas.php'),
                                    "filtering": {
                                            "enabled": true
                                    }
                            });
