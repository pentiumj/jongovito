...
$.extend($.validator, {
	...
	messages: {
		...
		url: "Digite un url válido.",
		date: "Digite una fecha válida (mm-dd-aaaa).",
		dateISO: "Digite una fecha válida (aaaa-mm-dd).",
		...
		range: $.validator.format("Por favor digite un valor entre {0} y {1}."),
		max: $.validator.format("Por favor digite un valor menor o igual a  {0}."),
		min: $.validator.format("Por favor digite un valor mayor o igual a  {0}.")
	},
