...
$username = "admin"; $password = '3d28e324d7df28182ae0dceb664a2243';

    $useruploadfolder = "sitjo/public/js/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "sitjo/public/js/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "sitjo/public/img/noticias";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "sitjo/public/img/noticias";
